User.create!(
  email: "scoobydooismylife@gmail.com",
  password: "topdogcb1",
  password_confirmation: "topdogcb1",
  name: "Camden Boyd",
  roles: "site_admin"
  )
...
10.times do |blog|
  Blog.create!(
    ...
    consequatur aut perferendis doloribus asperiores repellat. sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. 
